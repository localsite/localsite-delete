...
strVar += "      <\/div>";
strVar += "";
strVar += "      <div class=\"showApps local\" style=\"display:none;float:left; padding-top:6px\">";
...
strVar += "            <\/div>";
strVar += "            <div class=\"filterSelected\" style=\"padding-right:28px\">Georgia<\/div><!-- Entire State -->";
strVar += "          <\/div>";
strVar += "        <\/div>";
strVar += "";
strVar += "      <\/div>";
