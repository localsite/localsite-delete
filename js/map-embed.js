...
strVar += "";
strVar += "      ";
strVar += "      <div class=\"showApps local\" style=\"display:none;float:left; padding:6px 2px 0 0\">";
strVar += "        <i class=\"material-icons\" style=\"font-size:38px\">&#xE5C3;<\/i>";
strVar += "      <\/div>";
strVar += "";
...
strVar += "            <\/div>";
strVar += "            <div class=\"filterClickText locationTabText\">Georgia<\/div><!-- Entire State -->";
strVar += "          <\/div>";
strVar += "        <\/div>";
strVar += "";
strVar += "      <\/div>";
...
strVar += "                <div class=\"filterClickText\" id=\"showAppsText\"><\/div>";
strVar += "              <\/div>";
strVar += "            <\/div>";
strVar += "";
strVar += "        <\/div>";
...
strVar += "  <\/div>";
strVar += "";
strVar += "  <div style=\"display:none;margin:20px 10px 20px 17px; min-width:195px; line-height: 1.5em;\" class=\"layerclass open\">";
strVar += "    <div class=\"catList\" id=\"industryCatList\">";
strVar += "      <div>All Categories<\/div>";
